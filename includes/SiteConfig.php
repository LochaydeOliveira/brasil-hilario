...
/**
 * Classe para gerenciar configurações do site
 * Carrega automaticamente as configurações do banco de dados
 */
class SiteConfig {
    ...
    private function __construct() {
        global $conn;
        $this->configManager = new ConfigManager($conn);
        $this->loadConfigs();
    }
    ...
    /**
     * Obtém configurações de um grupo específico
     */
    ...
    /**
     * Gera CSS customizado baseado nas configurações de cores
     */
    ...
    /**
     * Gera códigos de integração para o head
     */
    ...
    /**
     * Gera códigos de integração para o final do body
     */
