-- Sistema de Grupos de Anúncios - Brasil Hilário
...
CREATE INDEX idx_grupos_localizacao ON grupos_anuncios(localizacao, ativo);
CREATE INDEX idx_grupos_items_ordem ON grupos_anuncios_items(grupo_id, ordem);

-- Verificar se as tabelas foram criadas
SELECT 'Tabelas criadas com sucesso!' as status;
SHOW TABLES LIKE 'grupos_anuncios%'; 