                            ...
                            <?php if (!empty($post['tags'])): ?>
                                <div class="post-tags mb-3">
                                    <?php foreach ($post['tags'] as $post_tag): ?>
                                        <a href="<?php echo BLOG_PATH; ?>/tag/<?php echo htmlspecialchars($post_tag['slug']); ?>" 
                ...
                <?php if ($total_pages > 1): ?>
                    <nav aria-label="Navegação de páginas">
                        <ul class="pagination justify-content-center">
                            <?php if ($page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?slug=<?php echo $tag_slug; ?>&page=<?php echo $page - 1; ?>">
                                        Anterior
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                <li class="page-item <?php echo $i === $page ? 'active' : ''; ?>">
                                    <a class="page-link" href="?slug=<?php echo $tag_slug; ?>&page=<?php echo $i; ?>">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                            <?php endfor; ?>
