...
<head>
    ...
    <style>
        ...
        .table-users .actions{min-width:360px}
...
<body>
    ...
    <div class="container admin-wrap my-4">
        ...
        <div class="table-responsive border rounded">
            <table class="table table-hover table-striped align-middle mb-0 table-users"><thead class="table-light"><tr><th>ID</th><th>Nome</th><th>E-mail</th><th>Status</th><th>Criado em</th><th style="width:220px">Ações</th></tr></thead><tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <form method="post" class="row g-1 align-items-center">
                            ...
                            <div class="col-12 col-lg-2"><input type="text" class="form-control form-control-sm" name="nome" value="<?php echo htmlspecialchars($u['nome']); ?>" placeholder="Nome"></div>
                            <div class="col-12 col-lg-3"><input type="email" class="form-control form-control-sm" name="email" value="<?php echo htmlspecialchars($u['email']); ?>" placeholder="E-mail"></div>
                            <div class="col-12 col-lg-3"><input type="password" class="form-control form-control-sm" name="senha" placeholder="Nova senha (opcional)"></div>
                            <div class="col-6 col-lg-2 d-flex align-items-center"><div class="form-check m-0"><input class="form-check-input" type="checkbox" name="ativo" id="ativo_<?php echo (int)$u['id']; ?>" <?php echo ((int)$u['ativo']===1?'checked':''); ?>><label class="form-check-label" for="ativo_<?php echo (int)$u['id']; ?>">Ativo</label></div></div>
                            <div class="col-6 col-lg-2 d-flex gap-1"><button class="btn btn-sm btn-primary w-100">Atualizar</button><button class="btn btn-sm btn-outline-secondary w-100" name="action" value="suspend">Suspender</button></div>
                        </form>
                    </td>
                </tr>
                <?php endforeach; ?>
