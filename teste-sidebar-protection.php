...
<head>
    ...
    <title>Teste Sidebar Protection</title>
...
<div class="container mt-4">
    <h1>Teste de Proteção da Sidebar</h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="test-container">
                ...
                <p>Esta área simula o conteúdo principal com anúncios AdSense.</p>
        ...
        <div class="col-md-4">
            <div class="sidebar-test">
                <h4>Sidebar Protegida (Z-Index: 100)</h4>
                <p>Esta é a sidebar que deve permanecer visível e acessível.</p>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <h5 class="mb-0">AdSense na Sidebar (Z-Index: 102)</h5>
                    </div>
                    <div class="card-body">
                        <ins class="adsbygoogle"
                             style="display:block; text-align:center;"
...
// Funções de teste
function runTests() {
    console.log('Executando testes de proteção...');
    ...
    const zIndexCorrect = sidebarZIndex >= 100;
    ...
    updateStatus('z-index-status', zIndexCorrect, 'Z-Index Correto', 'Z-Index Incorreto');
...
function showZIndexInfo() {
    const elements = document.querySelectorAll('.sidebar-test, .adsense-test, .card, .card-body');
...
console.log('Teste de Proteção da Sidebar carregado');
</script>
